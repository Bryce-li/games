  ...
  return (
    <div className="min-h-screen bg-[#f5f5f7] text-[#1c1c1e]">
      ...
      <header className="text-center mb-12">
        <h1 className="text-4xl text-[#007aff] mb-4">Stone Grass: Mowing Simulator</h1>
      ...
      <main className="container max-w-6xl mx-auto px-4 py-8">
        <section>
          <h2 className="text-3xl text-[#50c878] mt-8 mb-4">Play Stone Grass: Mowing Simulator Online</h2>
          <div className="relative w-full pb-[56.25%] my-8 bg-black rounded-xl overflow-hidden">
            <iframe
              src="https://www.crazygames.com/embed/stone-grass-mowing-simulator"
              title="Stone Grass: Mowing Simulator Game"
        ...
        <section>
          ...
          <p className="text-lg text-[#8e8e93] mb-4">
            Stone Grass: Mowing Simulator is a relaxing yet addictive game where you take control of a powerful mower and transform wild fields into perfectly trimmed landscapes. Glide smoothly through thick overgrowth, clearing grass with satisfying precision.
          </p>
        ...
        <section>
          ...
          <p className="text-lg text-[#8e8e93] mb-4">Playing Stone Grass: Mowing Simulator is straightforward but mastering it takes practice:</p>
